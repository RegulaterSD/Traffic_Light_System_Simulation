...
public class Vehicle3D {
     ...
     * @return A Group with the Car Shape and 3D Models stacked
     */
    private Group car(){
     ...
     * @param streetScene The scene that the vehicle is on
     * @param collidableVehicles The list of collidable vehicles
     */
    ...
    /**
     * This is to return if the car is stopped at a traffic light
     * @return True/False if it is stopped at a traffic light
     */
    ...
    /**
     * This is to return how long it has been in that intersection
     * @return The time it has been in the intersection
     */
    ...
    /**
     * To set the maximum time it should be in an intersection
     * @param time The time to set as the max
     */
    ...
    /**
     * Set the maximum time it can be stuck at the stop light
     * @param time The maximum time it can be stuck at the stop light
     */
